...
* TODO Associate a conversation to a Memo
  ...
  3. [ ] On successful generate text response, client makes call to create or update
     conversation. Passes the text_id and memo_id.
  4. [ ] If memo has conversation, update it; otherwise create a new conversation.
