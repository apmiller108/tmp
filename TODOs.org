...
* TODO Associate a conversation to a Memo [6/7]
  ...
  7. [ ] Generate image request belongs to a conversation optionally
  8. [ ] Include the conversation_id in the generate_text_request params:w
  9. [ ] If the conversation exists on the request, prepend it to the client API request.
