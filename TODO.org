...
* TODO Add support for PDFs
  ...
  Possible options:
  1. Attach a file to the gtr
  2. Drop a link in the chat, use regex to check for presence and add a document
     content block to the request
  3. Add support for using Anthropic's File API:
  ...
  - [X] build UI for uploading conversation context files. What about a drag and
    drop to add context?
  - [ ] Replace upload button with spinner during fetch post
  - [ ] delete conversation context
  - [ ] refresh conversation context
  - [ ] Add conversation context files to conversation
