...
* TODO support adding files to the prompt [11/14]
  ...
  - [ ] take into account cache tokens in the token usage count
        "cache_creation_input_tokens"=>0, "cache_read_input_tokens"=>1601,
  - [ ] Display the image in the conversation
  ...
  - [ ] Make generate_text_requests.model no null
