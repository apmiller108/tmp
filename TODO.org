...
* TODO Conversation UI enahcements [30/38]
  ...
  - [ ] Clear the form after the turn is created
  - [ ] Update list item on name / convo update. Move updated to top of list.
  - [ ] Remove header links from assistant response
  - [ ] Wrap each pre (code block) in a copy component
