...
* TODO Wire up search
  ...
  - [ ] Make ordering dynamic. When displaying search results, order by neighbor_distance
  ...
  - [ ] Show the results
  - [ ] When showing results show the query term with close icon to go back to default order
  - [ ] Color the top 9 results each a lighter shade in a gradient
