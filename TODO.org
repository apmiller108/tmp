...
* TODO support adding files to the prompt [3/9]
  ...
  - [ ] Instantiate the client based on vendor from selected model
  ...
  - [ ] Look into backend validation of mime types and file size
