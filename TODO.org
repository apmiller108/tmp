...
* TODO custom presets
  - [ ] Add preset_type enum to generate_text_presets table (default, custom)
  - [ ] Add join table users_presets. belongs to user and preset
  - [ ] Add route and CRUD actions
  - [ ] Add the views
  - [ ] Make and name your own presets
  - [ ] Link to new preset from conversation
  - [ ] Cache a reference to the conversation it was linked from so when
    creating it redirects back to the conversation
  - [ ] Make custom presets available in the preset drop down
