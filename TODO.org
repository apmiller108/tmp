...
* TODO support mermaid diagram
  - [ ] add mermaid js package
  - [ ] instruct LLM to always use mermaid syntax when asked to make a diagram
  - [ ] Add required css class to mermaid pre tags
