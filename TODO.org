...
* TODO add image generation to conversations [20/29]
  ...
  - [ ] Show spinner while image is loading. See also attachment preview
    component
  - [ ] Fix unable to scroll container when mouse if over popover
