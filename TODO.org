...
* TODO Wire up search
* TODO Conversation UI enahcements [10/20]
  ...
  - [ ] Highlight currently viewed conversation
  - [ ] If the conversation is being viewed when deleted, render new
  ...
  - [ ] Figure out something for the browser back button stuff
