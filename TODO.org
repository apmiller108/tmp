...
* TODO Conversation UI enahcements [27/38]
  ...
  - [ ] Fix prompt form when controls are collapsed
  - [ ] Change temp drop down to range
  - [ ] Find a better home for the conversation icons
