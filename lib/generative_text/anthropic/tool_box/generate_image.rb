    ...
    module ToolBox
      class GenerateImage
        ...
        DESCRIPTION = <<~TXT
          ...
          generative image AI model. Your job is to build the best image
          generating prompt. Turn the user's request into an optimize the prompt
          to produce the best image possible. Use adjectives and detailed
